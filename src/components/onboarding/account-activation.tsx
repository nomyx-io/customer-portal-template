  ...
  return (
    <div className="font-poppins flex flex-col min-h-[75vh]">
      <div className="flex flex-col justify-center items-center flex-grow">
        ...
        <h2 className="text-2xl font-extrabold text-[#1F1F1F] text-center">Account Activated!</h2>
        <p className="text-base mt-4 text-[#1F1F1F] text-center max-w-[600px]">Awesome! Now you can start your journey with us</p>
